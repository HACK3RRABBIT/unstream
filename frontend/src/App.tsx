  ...
  return (
    <div className="safe-x flex min-h-screen flex-col bg-ink-950">
      <header className="mx-auto flex w-full max-w-3xl items-center gap-2.5 px-5 pt-[calc(2rem+var(--safe-top))]">
        ...
        {/* Both are preferences rather than actions, so they share the trailing
            edge — quality first, since it changes what a download *is* and the
            language only how it's labelled. */}
